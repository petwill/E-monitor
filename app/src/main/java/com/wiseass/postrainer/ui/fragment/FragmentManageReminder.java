...
public class FragmentManageReminder extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        nosePicker.setIs24HourView(true);
        ...
        nosePicker.setHour(c.HOUR_OF_DAY);
        */
    ...
    private void validateInput() {
        ...
        if( titleInput.split("/").length != 4 ) {
            makeSomeToast("Imvalid Input Format");
        }
        else if (titleInput.equals("")) {
            makeSomeToast(getString(R.string.error_input_invalid_blank));
        } else if (titleInput.length() > 60) {
